...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " icountcoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  icountcoins-tx [options] <hex-tx> [commands]  Update hex-encoded icountcoins transaction\n" +
            "or:     icountcoins-tx [options] -create [commands]   Create hex-encoded icountcoins transaction\n" +
            "\n";
