...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting smoreoshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585981343, 270488, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf5bf34691ddb423d3dc9fa45871142260c716654d921d856cdea032e600ceea9"));
        assert(genesis.hashMerkleRoot == uint256S("0x33016ae4e020a582577e17990bdad2288fc5be8653293d43df0ba66d941df269"));
        ...
        vSeeds.emplace_back("seed-a.icountcoins.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.icountcoinstools.com");
        vSeeds.emplace_back("dnsseed.icountcoinspool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 557229, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x44b2104876f0ff63e7ed0bc95e28311490b64f715e0ba202720b8cb28b0ce9e6"));
        assert(genesis.hashMerkleRoot == uint256S("0x33016ae4e020a582577e17990bdad2288fc5be8653293d43df0ba66d941df269"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.icountcoinstools.com");
        vSeeds.emplace_back("seed-b.icountcoins.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xee466d876c08da10cd5894ca698a21976ff3fd1451ab3489564c00f6b495b444"));
        assert(genesis.hashMerkleRoot == uint256S("0x33016ae4e020a582577e17990bdad2288fc5be8653293d43df0ba66d941df269"));
