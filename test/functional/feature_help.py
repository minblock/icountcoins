...
"""Verify that starting icountcoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start icountcoins with -h for help text")
        ...
        self.log.info("Start icountcoins with -version for version information")
        ...
        self.log.info("Start icountcoinsd with -fakearg to make sure it does not start")
