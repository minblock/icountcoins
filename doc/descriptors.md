# Support for Output Descriptors in ICountCoins Core

Since ICountCoins Core v0.17, there is support for Output Descriptors. This is a
...
on ICountCoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing ICountCoins Core wallets, a convenience function `combo` is
